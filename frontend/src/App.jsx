  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      const message =
        ...
        "We could not analyze your resume. Ensure the backend server is running and try again.";
      ...
      <section className="hero">
        <div className="hero-content">
          ...
          <p>
            ...
            explainable improvement plan—not a black box verdict.
          </p>
        </div>
      </section>
          ...
          <>
            <div className="intro-copy">
              ...
              <p>
                ...
                ClearCall identifies skill, experience, and education gaps
                in seconds.
              </p>
            </div>
        ...
        {results && !loading && (
          <>
            ...
            <div className="results-stack">
              ...
              <RejectionReasons
                reasons={results.rejection_reasons}
              />

              <ImprovementPlan
                resumeFixes={results.resume_fixes}
                upskillingSuggestions={results.upskilling_suggestions}
              />
            </div>
          </>
        )}
